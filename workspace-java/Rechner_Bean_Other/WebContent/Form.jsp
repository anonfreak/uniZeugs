...
<body>
	<%-- Check input --%>
	<jsp:setProperty property="zahl1" name="calculatorBean" param="Zahl1" />
	<jsp:setProperty property="zahl2" name="calculatorBean" param="Zahl2" />
	<jsp:setProperty property="operation" name="calculatorBean"
		param="Operation" />
	<c:if test="${calculatorBean.OK}">
